...
const siteConfig = {
    ...
    projectName: 'ScalablyTypedConverter',
    organizationName: 'kurusugawa-computer',
    ...
    headerLinks: [
        {label: 'Github', href: 'https://github.com/ScalablyTyped/Converter'},
    ],
    ...
    headerIcon: 'img/logo-3.svg',
    footerIcon: 'img/logo-1.svg',
    favicon: 'img/favicon-st1.ico',

    /* Colors for website */
    colors: {
        primaryColor: '#317AC6',
        secondaryColor: '#383737',
    },
